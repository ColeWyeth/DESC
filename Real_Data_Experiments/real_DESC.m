...
[R_est_DESC, R_est_GCW, S_vec] = DESC(Ind', RijMat, params);
...
t20 = cputime;
R_est_GM = IRLS_GM(RijMat, Ind');
t2 = cputime-t20;

t30=cputime;
R_est_L12 = IRLS_L12(RijMat,Ind');
t3=cputime-t30;
%R_est_L12_CEMP = AverageL1(RijMat1,Ind, 'Rinit', R_est);


% set CEMP defult parameters
CEMP_parameters.max_iter = 5;
CEMP_parameters.reweighting = 2.^(1:5);
