...
%% CEMP_parameters.gcw_beta: coefficient of exponent converting cycle weights to edge weights (confidence in cycle weights)
...
%    Weights = exp(-CEMP_parameters.gcw_beta.*SMat_sq).*AdjMat; 
    Weights = (1 ./ (SMat_sq + 1e-8)) .* AdjMat;
